...
import { activatedSkillIds, createLLMTranslationModel, createTranslationProjectFromFile, loadAvailableAgentSkills, resolveProductionSkillActivations, runTranslationProject, writeTranslationExport, } from "@actalk/inkos-core";
...
function fail(prefix, error, json) {
    if (json) {
