...
import { formatChapterDeleteCancelled, formatChapterDeleteConfirm, formatChapterDeleteDone, formatChapterSyncChange, formatChapterSyncMissingFiles, formatChapterSyncNoChanges, formatChapterSyncSummary, resolveCliLanguage, } from "../localization.js";
    ...
    try {
        ...
        if (!opts.force) {
            ...
            const answer = await new Promise((resolve) => {
                rl.question(formatChapterDeleteConfirm(language, { bookTitle: book.title, bookId, number: target, title }), resolve);
            });
            rl.close();
