...
import { DEFAULT_REVISE_MODE, PipelineRunner, StateManager, resolveRevisionGate } from "@actalk/inkos-core";
import { loadConfig, buildPipelineConfig, findProjectRoot, resolveBookId, log, logError } from "../utils.js";
import { formatNotifyCommandTitle, formatNotifyFailureBody, formatNotifyReviseBody, resolveCliLanguage, } from "../localization.js";
    ...
    try {
        ...
        if (opts.json) {
            ...
            if (result.skippedReason)
                log(`  Reason: ${result.skippedReason}`);
        }
        else {
