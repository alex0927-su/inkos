...
configCommand
    ...
    try {
        ...
        if (opts.lang)
            lines.push(`INKOS_DEFAULT_LANGUAGE=${opts.lang}`);
...
function validateApiKeyEnvName(value) {
...
configCommand
    ...
    try {
        ...
        if (hasProviderOpts) {
            ...
            if (opts.baseUrl)
                override.baseUrl = opts.baseUrl;
            if (opts.provider)
                override.provider = opts.provider;
            if (opts.apiKeyEnv)
                override.apiKeyEnv = opts.apiKeyEnv;
    ...
    try {
        ...
        for (const [agent, value] of Object.entries(overrides)) {
            if (typeof value === "string") {
                ...
                const parts = [o.model];
                if (o.baseUrl)
                    parts.push(`@ ${o.baseUrl}`);
                if (o.stream === false)
                    parts.push("[no-stream]");
