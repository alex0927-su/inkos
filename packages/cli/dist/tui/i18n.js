...
export function resolveTuiLocale(env = process.env, preferredLanguage) {
...
export function getTuiCopy(locale) {
    return locale === "en" ? EN : ZH_CN;
}
export function normalizeStageLabel(label, copy) {
...
export function formatModeLabel(mode, copy) {
