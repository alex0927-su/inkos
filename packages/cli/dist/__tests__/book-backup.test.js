...
async function setupBook(bookId) {
...
describe("inkos book backup / restore commands", () => {
    ...
    it("creates a backup, lists it, and restores it via the CLI", async () => {
        ...
        expect(logErrorMock).not.toHaveBeenCalled();
        const restored = JSON.parse(logMock.mock.calls.at(-1)?.[0]);
...
//# sourceMappingURL=book-backup.test.js.map