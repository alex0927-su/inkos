...
const { buildPipelineConfigMock, createClientMock, findProjectRootMock, loadConfigMock, runAgentSessionMock, } = vi.hoisted(() => ({
...
//# sourceMappingURL=interact-command.test.js.map