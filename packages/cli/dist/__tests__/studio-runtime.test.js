...
describe("studio runtime resolution", () => {
    ...
    const projectBuiltEntry = join("/repo", "test-project", "node_modules", "@actalk", "inkos-studio", "dist", "api", "index.js");
    const cliBuiltEntry = join(cliPackageRoot, "node_modules", "@actalk", "inkos-studio", "dist", "api", "index.js");
...
//# sourceMappingURL=studio-runtime.test.js.map