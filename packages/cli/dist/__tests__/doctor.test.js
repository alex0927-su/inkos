...
describe("doctor model candidate probing", () => {
    ...
    it("uses the service-specific models endpoint when the preset defines one", () => {
        const modelsBaseUrl = resolveDoctorModelsBaseUrl("bailian", "https://dashscope.aliyuncs.com/apps/anthropic", (service) => service === "bailian" ? "https://dashscope.aliyuncs.com/compatible-mode/v1" : undefined);
