...
vi.mock("@actalk/inkos-core", () => ({
    ...
    resolveChapterReviewMode: (book, projectWriting) => book.writing?.reviewMode ?? projectWriting?.reviewMode ?? "auto",
}));
vi.mock("../utils.js", () => ({
...
describe("inkos write next review mode", () => {
    ...
    it("passes book-level reviewMode into the pipeline config", async () => {
        ...
        expect(buildPipelineConfigMock).toHaveBeenCalledWith(expect.anything(), "/project", expect.objectContaining({ chapterReviewMode: "manual" }));
...
//# sourceMappingURL=write-review-mode.test.js.map