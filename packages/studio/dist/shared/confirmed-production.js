const CONFIRMED_PRODUCTION_INTENTS = new Set([
    "create_book",
    "write_next",
    "short_run",
    "play_start",
...
export function isConfirmedProductionAction(actionSource, requestedIntent) {
    if (!requestedIntent || !CONFIRMED_PRODUCTION_INTENTS.has(requestedIntent))
        return false;
...
//# sourceMappingURL=confirmed-production.js.map