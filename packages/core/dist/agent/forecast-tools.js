...
import { createNarrativeForecast, getNarrativeForecast, selectNarrativeBranch, } from "../forecast/runner.js";
import { assertSafeBookId } from "../utils/book-id.js";
function textResult(text, details) {
    return { content: [{ type: "text", text }], details: details };
}
function resolveForecastBookId(toolName, paramsBookId, activeBookId) {
...
function describeForecast(forecast, stale) {
    return [
...
export function createNarrativeForecastCreateTool(pipeline, activeBookId, projectRoot) {
    return {
        name: "create_narrative_forecast",
        description: "Create a non-canonical narrative forecast for the current long-form book: reads the canonical context "
...
export function createNarrativeForecastGetTool(activeBookId, projectRoot) {
    return {
        name: "get_narrative_forecast",
        description: "Read an existing narrative forecast, re-check it against the current canonical context, and mark it stale when "
...
export function createNarrativeForecastSelectTool(activeBookId, projectRoot) {
    return {
        name: "select_narrative_branch",
        description: "Select one branch of a narrative forecast. Writes only selected-branch-plan.md inside the forecast directory — "
...
//# sourceMappingURL=forecast-tools.js.map