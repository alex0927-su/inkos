...
export function compareChapterSourceNames(left, right) {
 ...
 */
export async function loadChaptersFromPath(sourcePath, splitPattern) {
    ...
    if (sourceStat.isDirectory()) {
        ...
        return Promise.all(textFiles.map(async (f) => {
    ...
    if (chapters.length === 0) {
        throw new Error(`No chapters found in ${sourcePath}. ` +
...
//# sourceMappingURL=chapter-import-source.js.map