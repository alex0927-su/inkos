...
import { agentTrajectoryHeaders, beginAgentModelCall, } from "../llm/agent-trajectory.js";
/**
 ...
 */
export function guardedPiStream(model, context, options) {
    ...
    return guardAssistantMessageStream(model, (signal) => streamSimple(model, context, {
        ...options,
        headers: { ...(options?.headers ?? {}), ...traceHeaders },
        signal,
    }), options?.signal);
}
//# sourceMappingURL=pi-stream.js.map