import { PromptPackManifestSchema } from "./types.js";
const RAW_BUILTIN_PROMPT_PACKS = [
    {
        id: "longform",
...
export const BUILTIN_PROMPT_PACKS = RAW_BUILTIN_PROMPT_PACKS.map((pack) => PromptPackManifestSchema.parse(pack));
export const BUILTIN_PROMPTS = RAW_BUILTIN_PROMPTS;
//# sourceMappingURL=builtin-prompts.js.map