...
export function buildForecastSystemPrompt(language) {
    if (language === "en") {
        return [
...
export function buildForecastUserPrompt(input, language) {
...
export function buildForecastRepairPrompt(validationError, language) {
    if (language === "en") {
        return [
...
function forecastJsonShape(firstChapter, language) {
    if (language === "en") {
        return [
            "{",
            '  "branches": [',
