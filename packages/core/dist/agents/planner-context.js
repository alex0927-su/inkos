 ...
 * via dirname().
 */
export async function readCharacterMatrix(storyDir) {
...
export function formatRelevantThreads(hooks, subplotBoardRaw, language = "zh") {
