...
${chapterContent}`;
    ...
    parseResult(content) {
        ...
        for (let i = 1; i < lines.length; i++) {
            const line = lines[i];
            if (/^(PASS|REPAIR|FAIL)$/i.test(line))
                continue;
