...
import { createTranslationProjectFromFile, runTranslationProject, writeTranslationExport, } from "../translation/index.js";
describe("translation runner", () => {
    ...
    it("translates pending segments, persists review report, and resumes without duplicate model calls", async () => {
        ...
        const translateSegments = vi.fn(async ({ segments }) => ({
...
//# sourceMappingURL=translation-runner.test.js.map