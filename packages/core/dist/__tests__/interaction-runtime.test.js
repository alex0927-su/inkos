...
describe("interaction runtime", () => {
    ...
    it("routes update_focus to the focus updater", async () => {
        ...
        expect(updateCurrentFocus).toHaveBeenCalledWith("harbor", "Bring the story back to the old harbor debt line.");
    });
    ...
    it("routes edit_truth to the truth-file updater", async () => {
        ...
        expect(writeTruthFile).toHaveBeenCalledWith("harbor", "current_focus.md", "# Current Focus\n\nBring the story back to the old harbor debt line.\n");
    });
...
//# sourceMappingURL=interaction-runtime.test.js.map