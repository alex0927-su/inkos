...
import { classifyTruthAuthority, normalizeTruthFileName, } from "../interaction/truth-authority.js";
import { executeEditTransaction, planEditTransaction, } from "../interaction/edit-controller.js";
...
describe("edit controller", () => {
    ...
    it("patches chapter text when the target only differs by whitespace", async () => {
        const bookDir = join(projectRoot, "books", "harbor");
        await writeFile(join(bookDir, "chapters", "0004_雨巷.md"), "# 第4章 雨巷\n\n她把账本\n塞进外套里，继续往前走。", "utf-8");
        const chapterIndex = [{
                number: 4,
                title: "雨巷",
                status: "ready-for-review",
    ...
    it("executes whole-chapter replacement and marks the chapter for review", async () => {
        ...
        await writeFile(join(bookDir, "story", "runtime", "chapter-0002.user-brief.md"), "保留雨夜证词。\n", "utf-8");
        const chapterIndex = [{
                number: 2,
                title: "旧章",
                status: "ready-for-review",
...
//# sourceMappingURL=edit-controller.test.js.map