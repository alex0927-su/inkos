...
import { generateNodeImage, buildSetImageRefDelta, nodeImageRelPath } from "../interactive-film/node-image.js";
...
const stub = { generateImage: async () => ({ buffer: PNG, extension: "png" }) };
...
//# sourceMappingURL=if-node-image.test.js.map