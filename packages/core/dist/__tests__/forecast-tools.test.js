...
import { createNarrativeForecastCreateTool, createNarrativeForecastGetTool, createNarrativeForecastSelectTool, } from "../agent/forecast-tools.js";
...
describe("narrative forecast agent tools", () => {
    ...
    beforeEach(async () => {
        ...
        const runtime = { client: { provider: "openai" }, model: "fake", projectRoot: root };
        pipeline = { createAgentContext: () => runtime };
    });
    afterEach(async () => {
        vi.restoreAllMocks();
...
//# sourceMappingURL=forecast-tools.test.js.map