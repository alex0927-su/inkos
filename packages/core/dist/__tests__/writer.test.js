...
function createGovernedWriterInput(chapter) {
    return {
        ...
        ruleStack: {
            layers: [{ id: "test", name: "Test", precedence: 1, scope: "local" }],
