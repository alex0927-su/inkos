...
import { detectDuplicateTitle, detectParagraphLengthDrift, detectParagraphShapeWarnings, resolveDuplicateTitle, normalizePostWriteSurface, validatePostWrite, } from "../agents/post-write-validator.js";
...
describe("validatePostWrite", () => {
    ...
    it("skips Chinese-only rules when the book language override is English", () => {
        ...
        const validateWithLanguage = validatePostWrite;
