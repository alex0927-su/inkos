...
import { buildForecastContext, computeContextFingerprint, renderForecastContextMarkdown, } from "../forecast/context-builder.js";
async function writeFixtureBook(bookDir) {
...
describe("buildForecastContext", () => {
    ...
    it("ignores non-canonical runtime files, including forecast artifacts", async () => {
        ...
        await writeFile(join(bookDir, "story", "runtime", "narrative-forecasts", "fc-001", "forecast.json"), JSON.stringify({ forecastId: "fc-001" }), "utf-8");
        const after = await buildForecastContext({ bookDir, bookId: "demo" });
...
//# sourceMappingURL=forecast-context.test.js.map