...
function chapterEntry(number, title) {
...
async function setupBook(params) {
    ...
    await writeFile(join(bookDir, "chapters", "index.json"), JSON.stringify(params.chapters.map((c) => chapterEntry(c.number, c.title)), null, 2), "utf-8");
...
//# sourceMappingURL=chapter-delete.test.js.map