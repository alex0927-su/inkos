...
import { agentTrajectoryHeaders, beginAgentModelCall, opaqueConversationId, runAsWorkflowTrajectory, runWithAgentTrajectory, runWithAgentTrajectoryRole, } from "../llm/agent-trajectory.js";
describe("InkOS agent trajectory metadata", () => {
    ...
    it("keeps one run while assigning roles and preserving the parent Pi turn", async () => {
        await runWithAgentTrajectory({
            ...
            const subagent = await runWithAgentTrajectoryRole("subagent", async () => beginAgentModelCall(), "tool-7");
...
//# sourceMappingURL=agent-trajectory.test.js.map