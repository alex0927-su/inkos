...
describe("resolveChapterReviewMode", () => {
    it("book-level reviewMode overrides project-level reviewMode", () => {
        expect(resolveChapterReviewMode({ writing: { reviewMode: "manual" } }, { reviewMode: "auto" })).toBe("manual");
        expect(resolveChapterReviewMode({ writing: { reviewMode: "auto" } }, { reviewMode: "manual" })).toBe("auto");
    });
    it("falls back to project-level reviewMode when book does not set one", () => {
        ...
        expect(resolveChapterReviewMode({ writing: {} }, { reviewMode: "manual" })).toBe("manual");
    });
...
//# sourceMappingURL=chapter-review-mode.test.js.map