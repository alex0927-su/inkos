...
describe("listModelsForService (B8)", () => {
    ...
    afterEach(() => {
        if (originalEnv)
            process.env.INKOS_LLM_MODEL = originalEnv;
        else
            delete process.env.INKOS_LLM_MODEL;
    ...
    it("bailian 不用 OpenAI 兼容 /models 污染 Anthropic 通道模型列表", async () => {
        ...
        expect(fetchMock).not.toHaveBeenCalledWith("https://dashscope.aliyuncs.com/compatible-mode/v1/models", expect.any(Object));
...
//# sourceMappingURL=list-models.test.js.map