...
describe("buildWriterSystemPrompt", () => {
    ...
    it("enforces narrative person only when the user explicitly set one (#290)", () => {
        ...
        const promptFirst = buildWriterSystemPrompt(BOOK, GENRE, firstPerson, "# Book Rules", "# Genre Body", "# Style Guide", undefined, 3, "creative", undefined, "zh", "governed");
        ...
        const promptNone = buildWriterSystemPrompt(BOOK, GENRE, noPerson, "# Book Rules", "# Genre Body", "# Style Guide", undefined, 3, "creative", undefined, "zh", "governed");
