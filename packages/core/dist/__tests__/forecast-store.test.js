...
describe("ForecastStore", () => {
    ...
    it("refuses to save an invalid forecast and leaves no files behind", async () => {
        ...
        await expect(store.save(invalid, "cmp")).rejects.toThrow();
    ...
    it("writes selected-branch-plan.md next to forecast.json", async () => {
        ...
        expect(planPath).toBe(join(bookDir, "story", "runtime", "narrative-forecasts", forecast.forecastId, "selected-branch-plan.md"));
...
//# sourceMappingURL=forecast-store.test.js.map