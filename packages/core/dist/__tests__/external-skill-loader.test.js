...
import { createSkillRegistry, loadAvailableAgentSkills, loadBuiltinAgentSkills, loadConfiguredAgentSkills, loadExternalAgentSkills, parseAgentSkillDocument, } from "../skills/index.js";
...
describe("external skill loader", () => {
    ...
    it("rejects discovery metadata larger than the Agent Skills limits", () => {
        expect(() => parseAgentSkillDocument([
            ...
            "---",
            "Body.",
        ].join("\n"), { skillPath: join(root, "SKILL.md") })).toThrow(/name.*64/i);
        expect(() => parseAgentSkillDocument([
            "---",
            ...
            "---",
            "Body.",
        ].join("\n"), { skillPath: join(root, "SKILL.md") })).toThrow(/description.*1024/i);
    });
    ...
    it("discovers AgentSkills/OpenClaw project roots and one grouping level", async () => {
        ...
        await writeFile(join(groupedSkillDir, "SKILL.md"), [
            "---",
            "name: writer-distillation",
...
//# sourceMappingURL=external-skill-loader.test.js.map