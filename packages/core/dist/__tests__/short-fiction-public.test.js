...
import { ShortFictionOutlineAgent, ShortFictionOutlineReviserAgent, ShortFictionDraftReviserAgent, parseShortFictionBatchDraft, validateShortFictionDraftForFinal, } from "../agents/short-fiction.js";
import { saveSecrets } from "../llm/secrets.js";
import { extractGeminiImageBase64, extractImagesGenerationImage, generateShortFictionCover, resolveCoverGenerationRequest, } from "../pipeline/short-fiction-runner.js";
...
describe("public short-fiction chain", () => {
    it("gives outline generation enough output budget for models with a separate reasoning channel", async () => {
        ...
        const createChat = vi
            .spyOn(ShortFictionOutlineAgent.prototype, "chat")
            .mockResolvedValue({ content: validOutline, usage: ZERO_USAGE });
        const reviseChat = vi
            .spyOn(ShortFictionOutlineReviserAgent.prototype, "chat")
            .mockResolvedValue({ content: validOutline, usage: ZERO_USAGE });
...
`, { expectedChapters: 1 });
        const chatSpy = vi
            .spyOn(ShortFictionDraftReviserAgent.prototype, "chat")
            .mockResolvedValue({
            content: `
=== SHORT_FICTION_TITLE ===
新稿标题
...
`,
    ...
    it("generates a standalone cover artifact without running the short fiction pipeline", async () => {
        ...
        try {
            ...
            expect(fetchMock).toHaveBeenCalledWith("https://images.example.test/v1/images/generations", expect.objectContaining({
                method: "POST",
...
//# sourceMappingURL=short-fiction-public.test.js.map