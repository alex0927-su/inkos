...
import { getBuiltinPrompt, loadPromptPackPrompt, promptOverridePath, } from "../prompts/index.js";
async function tempProject() {
    return await mkdtemp(join(tmpdir(), "inkos-prompt-pack-"));
}
async function writePrompt(root, promptId, content) {
...
//# sourceMappingURL=prompt-pack.test.js.map