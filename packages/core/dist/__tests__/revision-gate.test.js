...
describe("resolveRevisionGate", () => {
    it("book-level revisionGate overrides project-level revisionGate", () => {
        expect(resolveRevisionGate({ writing: { revisionGate: "always" } }, { revisionGate: "lenient" })).toBe("always");
        expect(resolveRevisionGate({ writing: { revisionGate: "strict" } }, { revisionGate: "always" })).toBe("strict");
    });
    it("falls back to project-level revisionGate when book does not set one", () => {
        ...
        expect(resolveRevisionGate({ writing: {} }, { revisionGate: "always" })).toBe("always");
    });
...
//# sourceMappingURL=revision-gate.test.js.map