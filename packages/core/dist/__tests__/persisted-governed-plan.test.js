...
describe("persisted-governed-plan round trip", () => {
    it("savePersistedPlan + loadPersistedPlan returns equal memo", async () => {
        ...
        await writeFile(join(dir, "story", "runtime", "chapter-0001.intent.md"), "# Chapter Intent\n\n## Goal\n取回账册离开旧港\n", "utf-8");
...
//# sourceMappingURL=persisted-governed-plan.test.js.map