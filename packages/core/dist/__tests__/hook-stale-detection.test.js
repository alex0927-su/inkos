...
describe("computeHookDiagnostics — Phase 7 stale / blocked detection", () => {
    ...
    it("renderHookDiagnosticMarker formats zh / en markers correctly", () => {
        ...
        expect(renderHookDiagnosticMarker(diag, "zh")).toBe("过期 (距=20/半衰=10); 受阻于 H-up (已阻 7 章)");
        expect(renderHookDiagnosticMarker(diag, "en")).toBe("stale (d=20/half=10); blocked on H-up (blocked 7 chapters)");
    });
...
//# sourceMappingURL=hook-stale-detection.test.js.map