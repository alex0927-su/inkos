...
import { parseDraftDirectives, createDirectiveStreamFilter, } from "../interaction/draft-directive-parser.js";
// ---------------------------------------------------------------------------
...
describe("parseDraftDirectives", () => {
    ...
    it("extracts a single :::field block", () => {
        ...
        expect(result.textContent).toBe(["请为你的小说起一个名字：", "", "", "很好的名字！"].join("\n"));
        expect(result.raw).toBe(raw);
    });
    // ---------------------------------------------------------------------------
...
//# sourceMappingURL=draft-directive-parser.test.js.map