...
import { buildShortFictionDraftContinuationUserPrompt, buildShortFictionDraftReviewSystemPrompt, buildShortFictionDraftReviewUserPrompt, buildShortFictionDraftRevisionFollowup, buildShortFictionOutlineReviewSystemPrompt, buildShortFictionOutlineReviewUserPrompt, buildShortFictionOutlineRevisionFollowup, buildShortFictionOutlineSystemPrompt, buildShortFictionOutlineUserPrompt, buildShortFictionPackageSystemPrompt, buildShortFictionPackageUserPrompt, buildShortFictionWriterSystemPrompt, buildShortFictionWriterUserPrompt, } from "../prompts/short-fiction.js";
import { ShortFictionDraftReviewerAgent, ShortFictionDraftReviserAgent, ShortFictionPackagingAgent, ShortFictionWriterAgent, parseShortFictionBatchDraft, parseShortFictionOutline, renderShortFictionDraftMarkdown, } from "../agents/short-fiction.js";
...
describe("short-fiction runner English branch", () => {
    ...
    function runtimes(projectRoot) {
        const context = { client: { provider: "openai" }, model: "fake", projectRoot };
...
//# sourceMappingURL=short-fiction-en.test.js.map