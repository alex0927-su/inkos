...
const g = (over) => StoryGraphSchema.parse({ schemaVersion: 1, projectId: "p", title: "T", variables: [], nodes: [], endings: [], ...over });
const codes = (graph) => reviewStoryGraph(graph).issues.map((i) => i.code);
...
//# sourceMappingURL=if-review-plus.test.js.map