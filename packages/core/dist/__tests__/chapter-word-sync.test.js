...
async function setupBook(params) {
    ...
    await writeFile(join(bookDir, "book.json"), JSON.stringify({ id: params.bookId, title: params.bookId, language: params.language ?? "zh" }), "utf-8");
...
//# sourceMappingURL=chapter-word-sync.test.js.map