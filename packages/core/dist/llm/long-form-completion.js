import { PartialResponseError, } from "./provider.js";
/**
 ...
 */
export async function completeLongForm(options) {
...
export function mergeExactContinuation(prefix, continuation) {
    if (!prefix)
        return continuation;
    if (!continuation)
        return prefix;
...
function continuationInstruction(language) {
    return language === "en"
...
//# sourceMappingURL=long-form-completion.js.map