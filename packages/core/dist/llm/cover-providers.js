...
export function resolveCoverProviderPreset(service) {
    return COVER_PROVIDER_PRESETS.find((provider) => provider.service === service);
}
export function normalizeCoverBaseUrl(value) {
...
export function coverSecretKey(service) {
    return `cover:${service}`;
}
//# sourceMappingURL=cover-providers.js.map