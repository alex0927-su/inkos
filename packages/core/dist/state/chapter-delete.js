 ...
 */
export async function deleteLatestChapter(deps, bookId, options = {}) {
    ...
    if (requested !== latest) {
        throw new Error(`Only the latest chapter (${latest}) can be deleted, but chapter ${requested} was requested. `
...
async function pickAvailableName(dir, fileName) {
...
//# sourceMappingURL=chapter-delete.js.map