 ...
 */
export function buildWritingMethodologySection(language) {
    if (language === "en") {
        return buildEnglishMethodology();
    }
    return buildChineseMethodology();
}
function buildChineseMethodology() {
    return `---
...
function buildEnglishMethodology() {
    return `---
...
//# sourceMappingURL=writing-methodology.js.map