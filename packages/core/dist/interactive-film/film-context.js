export function summarizeStoryGraph(graph) {
    const lines = [];
...
export function buildFilmAuthoringContext(graph) {
    const blocks = [summarizeStoryGraph(graph)];
...
//# sourceMappingURL=film-context.js.map